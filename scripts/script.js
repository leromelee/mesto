...
const popupCloseCard = document.querySelector('.popup_closecard');
const closeCardName = document.querySelector('.popup_closecard_name');
const closeCardPhoto = document.querySelector('.popup_closecard_photo');
